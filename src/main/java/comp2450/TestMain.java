...
//
//    /**
//     * Preloads default data (Person, Map, Gears, Activities) before the REPL starts.
//     * This helps for quick testing without manually creating each item.
//     */
//    private static Person preloadData(Map map) {
//        // Create Person
//        Person person = new Person("Umang", 70);
//
//        // Create Map
//        // Add some obstacles
//        Obstacle obs1 = new Obstacle("Tree");
//        obs1.addCoordinates(new Coordinates(2, 2));
//        obs1.addCoordinates(new Coordinates(2, 3));
//        map.addObstacle(obs1);
//
//        Obstacle obs2 = new Obstacle("Rock");
//        obs2.addCoordinates(new Coordinates(6, 5));
//        map.addObstacle(obs2);
//
//        // Add routes
//        Route route1 = new Route();
//        route1.addCoordinates(new Coordinates(0, 0));
//        route1.addCoordinates(new Coordinates(0, 1));
//        route1.addCoordinates(new Coordinates(1, 1));
//        map.addRoutes(route1);
//
//        Route route2 = new Route();
//        route2.addCoordinates(new Coordinates(5, 0));
//        route2.addCoordinates(new Coordinates(5, 1));
//        route2.addCoordinates(new Coordinates(5, 2));
//        map.addRoutes(route2);
//
//        // Add gears
//        Gears shoes = new Gears("Running Shoes", "For daily runs");
//        Gears helmet = new Gears("Helmet", "For cycling");
//        person.addGear(shoes);
//        person.addGear(helmet);
//
//        // Add activities
//        Calendar today = Calendar.getInstance();
//        Activity run = new Activity("Morning Run", route1, today, 5.0, person.getWeight(), shoes);
//        Activity cycle = new Activity("Evening Cycle", route2, today, 12.0, person.getWeight(), helmet);
//        person.addActivity(run);
//        person.addActivity(cycle);
//
//        // Attach this map to Person or make it accessible globally if needed
//        System.out.println("✅ Preloaded default data: person, map, gears, and activities.");
//        return person;
//    }
//    private static void runTracker(){
//
//        Scanner sc = new Scanner(System.in);
//        Map map = new Map("AutoMap", new Dimensions(10, 10));
//        Person person = preloadData(map);
//
//        boolean done = false;
//
//        while(!done){
