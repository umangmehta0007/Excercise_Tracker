...
public class ShowMap {
    ...
    final private IMapping[][]MY_GRID_ACTIVITIES;
     ...
     * @param MY_GRID_ACTIVITIES the 2D grid of {@link IMapping} representing activities
     ...
     */
    public ShowMap(IMapping[][] MY_GRID_ACTIVITIES, Person person, Calendar startingDate, Calendar endingDate) {
